...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$.fn.fullpage.setOnSlideLeave = function(value)
        {
		    options.onSlideLeave = value;
        };
		...
		*/
		function landscapeScroll(slides, destiny){
			...
			if(options.onSlideLeave){
				...
				if(!localIsResizing){
					$.isFunction( options.onSlideLeave ) && options.onSlideLeave.call( this, anchorLink, (sectionIndex + 1), prevSlideIndex, slideIndex, xMovement);
				}
			}
