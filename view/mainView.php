<?php
    ...
    (
        ...
        (
            ...
            'price'       => 65,
            'stock'       => 0,
            'purchasers'  => array('nana' => 1, 'chad' => 1, 'judie' => 4, 'tita' => 9),
            'stock_orig'  => 15,
            'stock_label' => 'Desired',
        ...
        (
            ...
            'price'       => 115,
            'stock'       => 0,
            'purchasers'  => array('david' => 1, 'tia bea' => 2, 'judie' => 2),
            'stock_orig'  => 5,
            'stock_label' => 'Nights',
        ...
        (
            ...
            'price'       => 80,
            'stock'       => 0,
            'purchasers'  => array('pat crain' => 1, 'tita' => 2),
            'stock_orig'  => 3,
            'stock_label' => 'Nights',
        ...
        (
            ...
            'price'       => 100,
            'stock'       => 0,
            'purchasers'  => array('shauna, allison & jackson' => 3),
            'stock_orig'  => 3,
            'stock_label' => 'Nights',
        ...
        (
            ...
            'price'       => 90,
            'stock'       => 0,
            'purchasers'  => array('kevin' => 1, 'matt' => 1, 'leasha' => 1),
            'stock_orig'  => 3,
            'stock_label' => 'Nights',
        ...
        (
            ...
            'price'       => 120,
            'stock'       => 0,
            'purchasers'  => array('nana' => 1, 'tia gloria' => 1),
            'stock_orig'  => 2,
            'stock_label' => 'Nights',
        ...
        (
            ...
            'price'       => 15,
            'stock'       => 5,
            'purchasers'  => array('sophia & george' => 2, 'judie' => 2, 'erinn' => 2, 'david & sierra' => 3),
            'stock_orig'  => 14,
            'stock_label' => 'Tickets',
        ...
        (
            ...
            'price'       => 75,
            'stock'       => 0,
            'purchasers'  => array('matt' => 1, 'vienna' => 1),
            'stock_orig'  => 2,
            'stock_label' => 'Tickets',
        ...
        (
            ...
            'price'       => 50,
            'stock'       => 0,
            'purchasers'  => array('tita' => 8, 'sierra & david' => 1),
            'stock_orig'  => 8,
            'stock_label' => 'Days',
        ...
        (
            ...
            'price'       => 30,
            'stock'       => 13,
            'purchasers'  => array('nana' => 2, 'tita' => 5),
            'stock_orig'  => 20,
            'stock_label' => 'Meals',
        ...
        (
            ...
            'price'       => 20,
            'stock'       => 0,
            'purchasers'  => array('vanessa & brad' => 1, 'chrissy & wade' => 4),
            'stock_orig'  => 4,
            'stock_label' => 'Desired',
        ...
        (
            ...
            'price'       => 25,
            'stock'       => 3,
            'purchasers'  => array('matt' => 1, 'lucas' => 1),
            'stock_orig'  => 5,
            'stock_label' => 'Desired',
        ...
        (
            ...
            'price'       => 5,
            'stock'       => 0,
            'purchasers'  => array('kevin' => 2, 'matt' => 2, 'michelle' => 3, 'sophia & george' => 3),
            'stock_orig'  => 10,
            'stock_label' => 'Desired',
        ...
        (
            ...
            'price'       => 10,
            'stock'       => 16,
            'purchasers'  => array('matt' => 2, 'erinn' => 2),
            'stock_orig'  => 20,
            'stock_label' => 'Cups',
        ...
        (
            ...
            'price'       => 60,
            'stock'       => 0,
            'purchasers'  => array('brian' => 3, 'tita' => 5),
            'stock_orig'  => 5,
            'stock_label' => 'Desired',
    ...
    (
        'title'        => $title,
        'type'         => 'website',
        'description'  => "Vincent Garcia and Jacklin Sammis' Official Wedding Website",
        'url'          => "http://vincejacklinforever.com/$url",
        'image'        => 'http://vincejacklinforever.com/images/fox-sign.jpg',
        'image:type'   => 'image/jpeg',
        'image:width'  => '1200',
        'image:height' => '1600',
    );
    if(!isset($shareInfo)) $shareInfo = array();
    $shareInfo = array_merge($defaultShareInfo, $shareInfo);
